...
# Calculate expected result using manual algorithm
expected_C = manual_matrix_multiply(A, B)
...
print(f"Time taken for single-threaded manual matrix multiplication: {end_time - start_time} seconds")
